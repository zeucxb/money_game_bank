...
class BeneficiarySelectionDialog extends StatefulWidget {
  ...
  const BeneficiarySelectionDialog({Key key, @required this.beneficiaries}) : super(key: key);

  @override
  _BeneficiarySelectionDialogState createState() => _BeneficiarySelectionDialogState();
}

class _BeneficiarySelectionDialogState extends State<BeneficiarySelectionDialog> {
